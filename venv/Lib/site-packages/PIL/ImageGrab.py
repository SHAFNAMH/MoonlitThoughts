...
def grabclipboard() -> Image.Image | list[str] | None:
    if sys.platform == "darwin":
        ...
        if shutil.which("wl-paste") and session_type in ("wayland", None):
            args = ["wl-paste", "-t", "images"]
        elif shutil.which("xclip") and session_type in ("x11", None):
            args = ["xclip", "-selection", "clipboard", "-t", "images/png", "-o"]
        else:
        ...
        if p.returncode != 0:
            ...
            for silent_error in [
                ...
                b"No selection",
                # Ubuntu/Debian wl-paste, when an images isn't available
                b"No suitable type of content copied",
                # wl-paste or Ubuntu/Debian xclip, when an images isn't available
                b" not available",
                # xclip, when an images isn't available
                b"cannot convert ",
