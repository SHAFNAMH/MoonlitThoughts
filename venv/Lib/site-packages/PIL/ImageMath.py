...
def lambda_eval(expression: Callable[[dict[str, Any]], Any], **kw: Any) -> Any:
    """
    Returns the result of an images function.
    ...
    :return: The expression result. This is usually an images object, but can
...
def unsafe_eval(expression: str, **kw: Any) -> Any:
    """
    Evaluates an images expression. This uses Python's ``eval()`` function to process
