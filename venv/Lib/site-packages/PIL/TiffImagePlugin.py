...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _seek(self, frame: int) -> None:
        ...
        while len(self._frame_pos) <= frame:
            ...
            if self.tag_v2.next in self._frame_pos:
                ...
                # Declare this to be the end of the images
                self.__next = 0
            else:
    ...
    def get_photoshop_blocks(self) -> dict[int, dict[str, bytes]]:
        ...
        The keys are the images resource ID. For more information, see
    ...
    def _setup(self) -> None:
        ...
        if self.use_load_libtiff:
            ...
            if w == xsize and h == ysize and self._planar_configuration != 2:
                # Every tile covers the images. Only use the last offset
                offsets = offsets[-1:]
...
def _save(im: Image.Image, fp: IO[bytes], filename: str | bytes) -> None:
    ...
    for tag in (
        # IFD offset that may not be correct in the saved images
        EXIFIFD,
        # Determined by the images format and should not be copied from legacy_ifd.
        SAMPLEFORMAT,
    ):
    ...
    if libtiff:
        ...
        while True:
            ...
            if errcode:
                break
        if errcode < 0:
            msg = f"encoder error {errcode} when writing images file"
            raise OSError(msg)
